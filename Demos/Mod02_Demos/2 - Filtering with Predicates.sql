...
-- useful when you are looking for something like FR-R92B-58
...
SELECT TOP(10) * FROM SalesLT.Product WHERE SellEndDate IS NOT NULL;
SELECT TOP(10) Name, ProductNumber, Color,  FROM SalesLT.Product WHERE SellEndDate IS NOT NULL;
